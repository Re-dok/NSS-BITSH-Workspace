...
if (cardDatalocal.length === 0) {
      ...
      return (
            ...
            <Jumbotron
             ...
             bodyText={["We are a family of 150 dedicated volunteer work force who believe that welfare of an individual is ultimately the welfare of entire nation. We are working hard to ensure that everyone in our society who is needy gets the every possible help to lead a dignified life.",<br></br>, "NSS BPHC ",
             <span style={{
                              color:"#f1633b",
                              display:"contents",
                        }}>NOT ME BUT YOU!</span>]}
